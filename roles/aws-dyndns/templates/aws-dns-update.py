""" Based on https://github.com/danpilch/aws-dyndns """
import boto3
import json
import urllib
import argparse
...
class AWSDynDns(object):
    def __init__(self, region, domain, subdomain, hosted_zone_id, ttl):
...
if __name__ == "__main__":
    ...
    run = AWSDynDns(args.region, args.domain, args.subdomain, args.zone, args.ttl)
    run.update_record()
